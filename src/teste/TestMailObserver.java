...
public class TestMailObserver {
	...
	public void test() {
		...
		MailObserver observer = new MailObserver(imm);
		observer.update(serviciu.Consultanta, 1);
		String expected = observer.getClient().toString() + "care a solicitat serviciul "
				+ serviciu.Consultanta.toString() + " a fost anuntat prin mail";
		expected += sep;
		...
		expected2 += observer.getClient().toString() + "care a solicitat serviciul " + serviciu.Consultanta.toString()
				+ " a fost anuntat prin mail";
		expected2 += sep;
		...
		expected3 += observer.getClient().toString() + "care a solicitat serviciul " + serviciu.Consultanta.toString()
				+ " a fost anuntat prin mail";
		expected3 += sep;
